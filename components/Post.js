...
function Post({ id, username, userImg, img, caption }) {
    ...
    useEffect(() => onSnapshot(query(collection(db, 'posts', id, 'comments'), orderBy('timestamp', 'asc')), (snapshot) => setComments(snapshot.docs)), [db, id]);
        ...
        <div className="bg-white my-7 border rounded-sm">
            ...
            {session && (
                <form className="flex items-center p-4">
                    ...
                    <input type="text" className="border-none flex-1 focus:ring-0 outline-none" placeholder="add a comment..." value={comment} onChange={e => setComment(e.target.value)} />
                    <button type="submit"
